...
pub fn write_checkpoint(squares_by_class: &SquaresByClass, sums_by_class: &SumsByClass, centers_to_check: &CentersToCheck, next_checkpoint: u64, number: u32) {
    print!("Checked all magic sums below {}. ", number * number);
